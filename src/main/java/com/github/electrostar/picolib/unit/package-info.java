...
/**
 * Unit Classes implements the interface beetween the driver and Java Representations.
 * It also implements the representation of a series, their callbacks
 * and an abstraction layer for the concrete series.
 * 
 * @since 0.0.1
