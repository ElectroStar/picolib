...
/**
 * Tests for the {@link ChannelSettings} class.
 * 
 * @author <a href="mailto:startrooper@startrooper.org">ElectroStar</a>
 */
public class ChannelSettingsTest {

  public ChannelSettingsTest() {
  }

  /**
   * Test of all method, of class ChannelSettings.
   */
  @Test
  public void testPojo() {
    Assertions.assertPojoMethodsFor(ChannelSettings.class).areWellImplemented();
  }
}
