...
/**
 * Tests for the {@link GeneratorSettings} class.
 * 
 * @author <a href="mailto:startrooper@startrooper.org">ElectroStar</a>
 */
public class GeneratorSettingsTest {

  public GeneratorSettingsTest() {
  }

  /**
   * Test of all method, of class GeneratorSettings.
   */
  @Test
  public void testPojo() {
    Assertions.assertPojoMethodsFor(GeneratorSettings.class).areWellImplemented();
  }
}
