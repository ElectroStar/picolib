...
/**
 * Tests for the {@link TriggerSettings} class.
 * 
 * @author <a href="mailto:startrooper@startrooper.org">ElectroStar</a>
 */
public class TriggerSettingsTest {

  public TriggerSettingsTest() {
  }

  /**
   * Test of all method, of class TriggerSettings.
   */
  @Test
  public void testPojo() {
    Assertions.assertPojoMethodsFor(TriggerSettings.class).areWellImplemented();
  }
}
