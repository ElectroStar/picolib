...
/**
 * Tests for the {@link EtsSettings} class.
 * 
 * @author <a href="mailto:startrooper@startrooper.org">ElectroStar</a>
 */
public class EtsSettingsTest {

  public EtsSettingsTest() {
  }

  /**
   * Test of all method, of class EtsSettings.
   */
  @Test
  public void testPojo() {
    Assertions.assertPojoMethodsFor(EtsSettings.class).areWellImplemented();
  }
}
