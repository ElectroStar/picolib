...
/**
 * Tests for the {@link PicoException} class.
 * 
 * @author <a href="mailto:startrooper@startrooper.org">ElectroStar</a>
 */
public class PicoExceptionTest {
  
  /**
   * Test of Constructors of class PicoException.
   */
  @Test
  public void testConstructors() {
    Assertions.assertPojoMethodsFor(PicoException.class)
