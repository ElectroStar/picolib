...
/**
 * Tests for the {@link UnitNotFoundException} class.
 * 
 * @author <a href="mailto:startrooper@startrooper.org">ElectroStar</a>
 */
public class UnitNotFoundExceptionTest {
  
  /**
   * Test of Constructors of class UnitNotFoundException.
   */
  @Test
  public void testConstructors() {
    Assertions.assertPojoMethodsFor(UnitNotFoundException.class)
